...
excerpt: "Ini adalah nota draf untuk Bab 4: Cara Kira Position Sizing (Lot Size). Kandungan akan dikemaskini dalam versi seterusnya."
---

# Bab 4: Cara Kira Position Sizing (Lot Size)
...
Bab 4: Cara Kira Position Sizing (Lot Size) merupakan salah satu topik penting di bawah silibus **Sarjana (Master): Pengurusan Risiko**. Topik ini direka khas untuk tahap **Advanced**.
