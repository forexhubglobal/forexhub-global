...
excerpt: "Ini adalah nota draf untuk Bab 2: Simple Moving Averages (SMA). Kandungan akan dikemaskini dalam versi seterusnya."
---

# Bab 2: Simple Moving Averages (SMA)
...
Bab 2: Simple Moving Averages (SMA) merupakan salah satu topik penting di bawah silibus **Sekolah Menengah (Middle School): Indikator Asas**. Topik ini direka khas untuk tahap **Intermediate**.
