...
excerpt: "Ini adalah nota draf untuk Bab 3: Memahami Inflasi (CPI, PPI). Kandungan akan dikemaskini dalam versi seterusnya."
---

# Bab 3: Memahami Inflasi (CPI, PPI)
...
Bab 3: Memahami Inflasi (CPI, PPI) merupakan salah satu topik penting di bawah silibus **Universiti (Graduate): Analisis Fundamental**. Topik ini direka khas untuk tahap **Advanced**.
