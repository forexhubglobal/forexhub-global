                ...
                <div className="relative">
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute right-0 mt-3 w-56 bg-black/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-fade-in-down z-50">
                      ...
                      <div className="p-2">
                        {user.email && ['admin@forexhub.com', 'test@forexhub.com', 'forexhubglobal2026@gmail.com'].includes(user.email.toLowerCase()) && (
                          <Link 
                            href="/admin"
                            onClick={() => setIsUserMenuOpen(false)}
                            className="flex items-center gap-3 px-3 py-2 text-sm text-neon-blue font-bold hover:text-white hover:bg-neon-blue/20 rounded-lg transition-colors mb-1"
                          >
