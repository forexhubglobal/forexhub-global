      ...
      <main className="bg-slate-50 min-h-screen py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-8">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Margin Calculator</span>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200">
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Kalkulator Margin</h1>
              <p className="text-slate-600">Kira margin yang diperlukan untuk membuka posisi baru.</p>
            </div>
            ...
            <form onSubmit={calculateMargin} className="space-y-6 max-w-lg mx-auto">
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Leverage (1:?)</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-4 flex items-center text-slate-400 font-bold">1:</div>
                  <input 
                    type="number" 
                    className="w-full border border-slate-300 rounded-xl pl-10 pr-4 py-3 bg-slate-50 focus:ring-2 focus:ring-primary-500 outline-none"
                    value={leverage}
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Saiz Lot (Unit)</label>
                <input 
                  type="number" 
                  step="0.01"
                  className="w-full border border-slate-300 rounded-xl px-4 py-3 bg-slate-50 focus:ring-2 focus:ring-primary-500 outline-none"
            ...
            {result !== null && (
              <div className="mt-10 p-8 bg-primary-50 border border-primary-200 rounded-2xl text-center animate-fade-in-up">
                <div className="text-primary-700 font-bold mb-2 uppercase tracking-wider text-sm">Margin Diperlukan</div>
