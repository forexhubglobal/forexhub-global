      ...
      <main className="bg-[#09090b] min-h-screen py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4">Kalendar Ekonomi Masa Nyata</h1>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Pantau jadual berita ekonomi penting seperti NFP, CPI, dan FOMC untuk merancang strategi trading anda.
            </p>
          </div>

          <div className="bg-black/40 backdrop-blur-md rounded-2xl shadow-sm border border-white/10 overflow-hidden p-2 sm:p-6">
            <KalendarEkonomi />
          </div>
        </div>
      </main>
