      ...
      <main className="bg-slate-50 min-h-screen py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-8">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Pip Calculator</span>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200">
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Kalkulator Pip</h1>
              <p className="text-slate-600">Kira dengan pantas nilai per pip mengikut matawang dan saiz lot anda.</p>
            </div>

            <form onSubmit={calculatePip} className="space-y-6 max-w-lg mx-auto">
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Pasangan Matawang (Pair)</label>
                <select 
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Saiz Dagangan (Unit)</label>
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Matawang Akaun</label>
                <select 
                  className="w-full border border-slate-300 rounded-xl px-4 py-3 bg-slate-50 focus:ring-2 focus:ring-primary-500 outline-none"
