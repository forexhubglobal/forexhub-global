...
export default function ThirdEyeRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/3rdeye-request', {
        method: 'POST',
  ...
  return (
    <div className="bg-[#09090b] text-slate-300 min-h-screen selection:bg-neon-blue selection:text-black pb-16">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 mt-16 relative">
        ...
        <div className="text-center mb-12 relative z-10">
          <h1 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">
            MOHON AKSES <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple">3RDEYE PRO</span>
          </h1>
                    ...
                    <label className={`relative flex cursor-pointer rounded-xl border p-4 shadow-sm focus:outline-none ${formData.plan === 'trial' ? 'border-neon-purple bg-neon-purple/10' : 'border-white/10 bg-[#09090b] hover:bg-white/5'}`}>
                      ...
                      <span className="flex flex-1">
                        <span className="flex flex-col">
                          ...
                          <span className="mt-1 flex items-center text-sm text-slate-400">Akses Penuh 3RDEYE PRO selama 5 Hari berturut-turut. Tiada komitmen.</span>
                        </span>
                      </span>
